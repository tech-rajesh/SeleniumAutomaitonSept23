...
public class ExtentReportsTestCase_Method1 {
	...
	public void startReport() {
		...
		htmlReporter = new ExtentHtmlReporter("./test-output/extentReport/Incedo_ExtentReport_final"+dateName_number+".html");
		...
		htmlReporter.config().setDocumentTitle("Incedo - Functional Automation/API Report");
		// Name of the report
